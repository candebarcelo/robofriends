...
import './src/index.css'; // the css file, which will apply to the components u render in this file
...
import App from './src/containers/App'; // if there's no file type, it'll assume it's .js
